...
public class Board {
    ...
    public Board() {
        ...
        fields[5] = new GUI_Shipping("default","Øresund","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
        ...
        fields[10] = new GUI_Jail("default","I Fængsel","subtext","beskrivelse",Color.BLACK,Color.BLACK);
        fields[11] = new GUI_Street("Frederiksberg","SubText","Beskrivelse","PRIS",Color.WHITE,Color.BLACK);
        fields[12] = new GUI_Brewery("default","Tuborg","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
        ...
        fields[15] = new GUI_Shipping("default","D.F.D.S","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
        ...
        fields[20] = new GUI_Refuge("default","Helle","subtext","beskrivelse",Color.BLACK,Color.BLACK);
        ...
        fields[25] = new GUI_Shipping("default","title","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
        ...
        fields[28] = new GUI_Brewery("default","title","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
        fields[29] = new GUI_Street("Title","SubText","Beskrivelse","PRIS",Color.WHITE,Color.BLACK);
        fields[30] = new GUI_Jail("default","title","subtext","beskrivelse",Color.BLACK,Color.BLACK);
        ...
        fields[35] = new GUI_Shipping("default","title","subtext","beskrivelse","leje",Color.BLACK,Color.BLACK);
